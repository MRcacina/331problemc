...
public class GUI extends JPanel {
	...
	void play() throws InterruptedException  {
		...
		System.out.println("Welcome to Train Program. Please write start and press enter to continue.");
		...
		while(true){
			...
			System.out.println("Which operation would you like to do ?"  +
					"**Press 1 to add Bus Trip.**" + 
					"**Press 2 to Sell Ticket.**" 
				+   "**Press 3 to edit Boarding Information.**"
				+   "**Press 4 to add Baggage Information.**"
				+   "**Press 5 to list all Bus Trips.**"
				+   "**Press 6 to list all Passengers in a Bus Trip.**");
			...
			if(first.equals("1")){
				...
				System.out.println("For which trip you would like to sell ticket. Please enter the departure location.");
				...
				System.out.println("For which trip you would like to edit boarding information ? Please enter the departure location.");
				...
				System.out.println("For which trip you would like to edit Baggage Information ? Please enter the departure location.");
				...
				for(BusTrips b : BusTripsArray){
					...
					t += "Departure Location : " + b.getDepartureLocation() 
				...
				System.out.println("For which trip you would like to display passenger list ? Please enter the departure location.");
